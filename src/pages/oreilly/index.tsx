      ...
      <ul className="list-disc space-y-4">
        ...
        <li>
          ...
          <ul className="list-inside list-decimal space-y-4 mt-4">
            ...
            <li>
              <NextLink href={'/oreilly/4-3-combined-material'}>
                <a className="text-teal-700">combined-material</a>
              </NextLink>
            </li>
            <li>
              <NextLink href={'/oreilly/4-4-mesh-normal-material'}>
                <a className="text-teal-700">mesh-normal-material</a>
              </NextLink>
            </li>
            <li>
              <NextLink href={'/oreilly/4-5-multi-material'}>
                <a className="text-teal-700">multi-material</a>
              </NextLink>
            </li>
            <li>
              <NextLink href={'/oreilly/4-6-mesh-lambert-material'}>
                <a className="text-teal-700">mesh-lambert-material</a>
              </NextLink>
            </li>
            <li>
              <NextLink href={'/oreilly/4-7-mesh-phong-material'}>
                <a className="text-teal-700">mesh-phong-material</a>
              </NextLink>
            </li>
          </ul>
        </li>
